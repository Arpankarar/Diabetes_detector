...
df = pd.read_csv("C:/Users/LENOVO/.spyder-py3/diabetes_predictor/diabetes.csv")
...
# preparing the data for X and Y
x = df.drop(['Outcome'], axis = 1)
y = df.iloc[:, -1]
x_train, x_test, y_train, y_test = train_test_split(x,y, test_size = 0.2, random_state = 0)


# function to get the data from user using the slide bar
def user_report():
...
# making a dictionary of the given user data
  user_report_data = {
...
# fiting the model with the training dataset and finally applying it to the user's data
...
output=''    #empty variable to store the final result.
if user_result[0]==0:
...
#  calculating the accuracy of the predicted result 
